...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2024 a las 16:54:10
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `calcula_nomina` (IN `fechanom` DATE, IN `cod_emp` INT, IN `salario` DECIMAL(10,0), IN `diastb` INT, IN `nhrn` INT, IN `presta` DECIMAL(10,0))   BEGIN
    ...
    SET smiv = 1300.000;
    SET auxtte = 140000;
    -- condicional de auxilio de transporte 
    IF salario <= 2 * smiv THEN
        SET subtte = auxtte / 30 * diastb;
    ELSE
        SET subtte = 0;
    END IF;
      INSERT INTO nomina (fecha_nomina, empleado_cod, salario_base, dias_trabajados, auxilio_transporte, no_hrecargo)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `contar_productos` (IN `dato` VARCHAR(50), OUT `total` INT UNSIGNED)   BEGIN
	SET total=(
   		 SELECT COUNT(*)
   		 FROM producto
   		 WHERE producto.proveedor_cod * dato);
END$$
...
CREATE TABLE `cartera` (
  ...
  `fecha_vencimiento` date DEFAULT (`fecha_factura` + interval 30 day),
  `dias_mora` int(11) DEFAULT timestampdiff(DAY,`fecha_vencimiento`,curdate()),
...
INSERT INTO `cartera` (`cod_factura`, `cliente_cod`, `fecha_factura`, `forma_pago`, `total_neto`, `fecha_vencimiento`, `dias_mora`, `pagada`) VALUES
(10, 9, '2023-08-08', 'credito', 281700, '2023-09-07', 231, 'N'),
(11, 9, '2023-08-08', 'credito', 523500, '2023-09-07', 231, 'N'),
(12, 10, '2023-08-08', 'credito', 782000, '2023-09-07', 231, 'N'),
(13, 10, '2023-08-09', 'credito', 570300, '2023-09-08', 230, 'N'),
(19, 13, '2023-08-12', 'credito', 416250, '2023-09-11', 227, 'N'),
(20, 14, '2023-08-13', 'credito', 841950, '2023-09-12', 226, 'N'),
(30, 9, '2023-08-18', 'credito', 28000, '2023-09-17', 221, 'N'),
(34, 8, '2023-08-19', 'credito', 285750, '2023-09-18', 220, 'N'),
(39, 12, '2023-08-22', 'credito', 1046200, '2023-09-21', 217, 'N');
...
INSERT INTO `categoria` (`cod_categoria`, `nombre_categoria`, `observaciones`, `abonos`) VALUES
(1, 'Lacteos', 'leche, yogurt y queso', 0),
(2, 'Panaderia', 'panes y reposteria', 0),
(3, 'Galleteria', 'galletas saladas y dulces', 0),
(4, 'Golosinas', 'Chupetas, caramelos y bombones', 0),
(5, 'Salsas', 'salsa de tomate y aderezos', 0),
(6, 'Refrescos', 'Bebidas gaseosas y jugos', 0),
(7, 'Carnes Frias', 'Salchichas, mortadelas y jamones', 0);
...
CREATE TABLE `cliente` (
  ...
  `no_dumento` varchar(25) NOT NULL,
...
INSERT INTO `cliente` (`nombre1`, `nombre2`, `apellido1`, `apellido2`, `tipo_documento`, `no_dumento`, `sexo`, `direccion`, `ciudad`, `fecha_ingreso`, `edad`, `telefono`, `estado_civil`, `tipo_cliente`, `activo`, `empleado_cod`, `cod_cliente`) VALUES
('Mario', 'Alexis', 'Aroca', 'Martinez', 'CC', '1122239857', 'masculino', 'CALLE 40 SUR #96-16', 'Bogota', '2024-03-14', 38, '3158097309', 'soltero', 'mayorista', '', 3, 1),
('Jeronimo', '', 'burgos', 'diez', 'CC', '10000459', 'masculino', 'CRA 98 # 58-90', 'Bogota', '2024-03-14', 40, '9015872', 'soltero', '', '', 3, 2),
('Estefania', 'Tatiana', 'Villegas', 'sierra', 'CC', '1023581203', 'masculino', 'TRV 110 #81-40', 'Bogota', '2024-03-14', 32, '6047599', 'casado', 'mayorista', '', 4, 3),
...
('Eliana', 'Marcela', 'Ramirez', 'Guerrero', 'NIT', '1222333445', '', 'Calle 181 #2-45 ', 'Barranquilla', '2024-03-14', 50, '8019053', 'viudo', 'mayorista', '', 5, 5),
('Jose', 'Gregorio', 'Carmona', 'Guerra', 'CC', '1091562345', 'masculino', 'Cra 3 A # 5-89', 'Barranquilla', '2024-03-14', 29, '3134409180', 'casado', 'detallista', '', 5, 6),
('Marcela', 'Eliana', 'De santis', 'Rodriguez', 'CC', '1091562348', '', 'calle 9b # 4-20', 'Cali', '2024-03-14', 35, '3108156310', 'union libre', 'mayorista', '', 6, 7),
...
(1, 'Alberto', 'Alexis', 'Santos', 'Martinez', 'CC', '1122239867', 'masculino', 'CALLE 40 SUR #96-16', '3158097309', 'furgon'),
...
(5, 'Diana', 'Marcela', 'Ramirez', 'Guerrero', 'NIT', '1222333445', 'femenino', 'Calle 181 #2-45 ', '8019053', 'furgon'),
(6, 'Jose', 'Carlos', 'Calle', 'Guerra', 'CC', '1091562345', 'masculino', 'Cra 3A # 5-89', '3134409180', 'camion'),
(7, 'Marcela', 'Sofia', 'Castro', 'Rodriguez', 'CC', '1091562348', 'femenino', 'calle 9b # 4-20', '3108156310', 'furgon');
...
CREATE TABLE `empleado` (
  ...
  `telefono` varchar(25) NOT NULL,
  `fecha_ingreso` date DEFAULT curdate(),
  `estado_civil` enum('soltero','soltera','casado','casada','divorciado','divorciada','union libre','viuda','viudo') DEFAULT NULL,
...
(7, 'Pablo', 'Santiago', 'Rojas', 'Duque', 'cc', 'masculino', 'Calle 100 # 11B-27 Bogota', 'bogota', 25, '3456676895', '2024-03-14', 'soltero', 2, 'primaria', 'capital salud', 'colfondos', 'davivienda', 'A', 1018765324, 0),
...
INSERT INTO `factura_detalle` (`cod_facdetall`, `factura_cod`, `producto_cod`, `cantidad`, `valor_venta`, `descuento`) VALUES
(1, 1, 1, 10, 3000, 0.00),
(2, 1, 2, 5, 8000, 0.00),
(3, 1, 3, 4, 3000, 0.00),
(4, 2, 1, 10, 3000, 0.00),
...
(8, 'Salchichas vaquera x pq', 5500, 7150, 8500, 4070, '2023-08-30', '2023-09-20', 7, 8),
(9, 'Mortadela vaquera x pq', 7500, 9350, 9500, 4071, '2023-08-30', '2023-09-20', 7, 8),
(10, 'Salchiperro vaquera x pq', 6500, 8250, 8500, 4072, '2023-08-30', '2023-09-20', 7, 8),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vista_empleado_clientes`  AS SELECT concat(`t1`.`nombre1`,`t1`.`apellido1`) AS `empleado`, concat(`t2`.`nombre1`,`t2`.`apellido1`) AS `cliente` FROM (`empleado` `t1` join `cliente` `t2`) WHERE `t1`.`cod_empleado` = `t2`.`empleado_cod` ;
...
ALTER TABLE `cliente`
  ...
  ADD KEY `fk_empleadocli` (`empleado_cod`);
...
ALTER TABLE `despachos`
  ...
  ADD KEY `despacho_ibfk_1` (`contratista_cod`),
  ADD KEY `despacho_ibfk_2` (`factura_cod`);
...
ALTER TABLE `empleado`
  ...
  ADD KEY `empleado_ibfk_1` (`cargo_cod`);
...
ALTER TABLE `entrada_cabeza`
  ...
  ADD KEY `entrada_cabeza_ibfk_1` (`proveedor_cod`),
  ADD KEY `entrada_cabeza_ibfk_2` (`empleado_cod`),
...
ALTER TABLE `entrada_detalle`
  ...
  ADD KEY `entrada_detalle_ibfk_1` (`entrada_cod`),
  ADD KEY `entrada_detalle_ibfk_2` (`producto_cod`);
...
ALTER TABLE `factura_cabeza`
  ADD PRIMARY KEY (`cod_factura`),
  ADD KEY `factura_cabeza_ibfk_1` (`cliente_cod`),
  ADD KEY `factura_cabeza_ibfk_2` (`empleado_cod`),
...
ALTER TABLE `factura_detalle`
  ADD PRIMARY KEY (`cod_facdetall`),
  ADD KEY `factura_detalle_ibfk_1` (`factura_cod`),
  ADD KEY `factura_detalle_ibfk_2` (`producto_cod`);
...
ALTER TABLE `producto`
  ...
  ADD KEY `productos_ibfk_1` (`categoria_cod`),
  ADD KEY `productos_ibfk_2` (`proveedor_cod`);
...
--
ALTER TABLE `factura_detalle`
  MODIFY `cod_facdetall` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `fk_empleadocli` FOREIGN KEY (`empleado_cod`) REFERENCES `empleado` (`cod_empleado`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `entrada_cabeza`
  ...
  ADD CONSTRAINT `fk_tipomove` FOREIGN KEY (`tipomov_cod`) REFERENCES `tipomov` (`cod_tipomov`);
